...
{
    public class GridMarkerGenProcessorSettings
    {
        public bool TransformCoordsToDungeonSpace = true;
    }
    public class GridMarkerGenProcessor : IMarkerGenProcessor
    {
        ...
        public GridMarkerGenProcessorSettings Settings = new GridMarkerGenProcessorSettings();
        ...
        public bool Process(MarkerGenPattern pattern, PropSocket[] oldMarkers, System.Random random, out PropSocket[] newMarkers)
        {
            ...
            if (Settings.TransformCoordsToDungeonSpace)
            {
